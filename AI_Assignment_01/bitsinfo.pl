info_bitsat_score_analysis:-
    ...
    nl,write("No of Candidates with score >=95%:       235"),
    nl,write("No of Candidates with score >=80%:       1790"),
    nl,write("No of Candidates with score >=70%:       6328"),
    nl,write("No of Candidates with score >=60%:       15563"),
    nl,write("No of Candidates with score >=50%:       29460"),
    nl.
